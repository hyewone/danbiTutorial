...
SECRET_KEY = 'django-insecure-ucu+@s!r%8o4c+x(db_iae*^i(%v2cw_f(e*5jb+it6l$z8j)v'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://port-0-danbitutorial-be-euegqv2llo6uapzm.sel5.cloudtype.app",  
]
